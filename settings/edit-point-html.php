<div id="ano-6310-edit-point" class="ano-6310-modal ano-6310-hide">
  <div class="ano-6310-modal-content ano-6310-modal-lg">
        ...
        <div class="tabbed-content-wrap">
          <div class="ano-6310-tab ano-6310-tab-1">
            <table border="0" width="100%" cellpadding="10" cellspacing="0"></table>             
              <button class="ano-6310-remove" onclick="ConfirmDelete()"><i class="fas fa-trash"></i>Delete</button>
          ...
          <table border="0" width="50%" cellpadding="10" cellspacing="0">
            <tr class="ano-6310-model-content">
              <td class='ano-6310-width-150'><label class="ano-6310-form-label" for="picture">Modal Content:</label></td>
              <td>
                <input type="text" data-value="Tooltip text" class="ano_6310_modal_content">
              </td>
            </tr> 
            <tr class="ano-6310-model-content">
          ...
          <tr class="ano-6310-model-content">
            ...
            <td>
              <input type="text" name="ano_6310_modal_content_background_color" class="ano-6310-form-input ano_6310_color_picker ano_6310_modal_content_background_color" data-format="rgb" data-value="rgb(255, 255, 255)" data-opacity="0.8">
            </td>
          </tr>
            <tr>
              <td class='ano-6310-width-150'><label class="ano-6310-form-label">Element Type:</label></td>
              <td>
                <input class='ano-6310-section-select' value='1' type="radio" name="popover_new" checked />Tooltip
          ...
          <div class="ano-6310-tab ano-6310-tab-4">
            <table border="0" width="50%" cellpadding="10" cellspacing="0">                         
              <tr height="40px" class="ano-6310-form-icon ano-6310-marker ano-6310-marker-type-1">
                ...
                <td>
                  <input type="text" name="ano_6310_select_area_color" class="ano_6310_select_area_color ano-6310-form-input ano_6310_color_picker" data-format="rgb" data-opacity="0.8" data-value="rgba(255, 13, 0, 0.5)">
                </td>
              </tr>
              <tr height="40px" class="ano-6310-form-icon ano-6310-marker ano-6310-marker-type-1">
                <td class='ano-6310-width-150'><label class="ano-6310-form-label" for="icons">Area Hover Color:</label></td>
                <td>
                  <input type="text" name="ano_6310_select_area_hover_color" class="ano-6310-form-input ano_6310_color_picker ano_6310_select_area_hover_color" data-format="rgb" data-opacity="0.8" data-value="rgba(255, 13, 0, 0.5)">
                </td>
              </tr>
              <tr height="40px" class="ano-6310-form-icon ano-6310-marker ano-6310-marker-type-1">
                <td class='ano-6310-width-150'><label class="ano-6310-form-label" for="icons">Border size:</label></td>
                <td>
                  <input type="number" min='0' max="" name="ano-6310_area_border_size" class="ano-6310-form-input ano-6310_area_border_size" data-value="2">
                </td>
              </tr>
    ...
    <button type="button" name="close" class="ano-6310-btn-danger ano-6310-btn-close ano-6310-pull-right">Close</button>
      <input type="submit" name="submit" class="ano-6310-btn-primary ano-6310-pull-right ano-6310-margin-right-10 ano-6310-update-place-save" value="Done" />
    </div>
