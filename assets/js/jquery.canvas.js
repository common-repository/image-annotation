(function ($) {
  ...
  var init = function (index, input, options) {
    ...
    settings = $.extend(
      {
        imageUrl: $(this).attr("ano-6310-image-url"),
      },
      options
    );
    ...
    $reset = $(
      '<div class="ano-6310-submenu"><div class="ano-6310-clear"><i class="fas fa-eraser"></i> Clear</div><div class="ano-6310-undo"><i class="fas fa-undo"></i> Undo</div></div>'
    );
    $canvas = $("<canvas>");
    ...
    $(`${options} .ano-6310-canvas-wrapper`).append(
      $reset,
      "<br>",
      $canvas
    );
    ...
    $(document).find('.ano-6310-clear').click(reset);
  ...
  $(document).ready(function () {
    // $(".ano-6310-canvas-area[ano-6310-image-url]").canvasAreaDraw();
  });
